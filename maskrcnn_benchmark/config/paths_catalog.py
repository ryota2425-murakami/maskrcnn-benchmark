...
class DatasetCatalog(object):
    DATA_DIR = "maskrcnn_benchmark/"
    DATASETS = {
       "coco_fish_train": {
            "img_dir": "data/datasets/cocoformat_goldfish",
            "ann_file": "data/datasets/cocoformat_goldfish/annotations.json"
        },

        "coco_2017_train": {
            "img_dir": "data/datasets/evaluation/dataset/train",
            "ann_file": "data/datasets/evaluation/dataset/train/via_region_data.json"
        },
         "coco_2017_val": {
            "img_dir": "data/datasets/evaluation/dataset/val",
            "ann_file": "data/datasets/evaluation/dataset/val/via_region_data.json"
        },
        "coco_2017_trains": {
